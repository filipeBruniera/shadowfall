...
- **Linha de quem falta**, com até dois nomes; acima disso, *"Faltam 4 jogadores"*.
...
*"Descendo…"*. Ao completar, `#banner` assume com o andar novo.
...
- Uma linha em `#log .warn`: *"Marina saiu do portal."*
...
- Abaixo de `520px` a linha de nomes vira só a contagem: *"Faltam 2"*.
