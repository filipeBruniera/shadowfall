...
- [x] T01 — Curva de chefe, fatores HARDCORE e janelas de carga em `js/balance.js`
...
- [x] T02 — Constantes do status `wither` em `js/balance.js`
      Arquivos: `js/balance.js`
...
- [x] T03 — Kit de especiais por chefe e mapa `ELEM_STATUS` em `js/data.js`
      Arquivos: `js/data.js`
...
- [x] T04 — Buffer `G.pendingEvents` para eventos empilhados fora do tique
      Arquivos: `js/sim.js`
...
- [x] T05 — `populate()` e `makeMonster()` com `bossCurve` e flag HARDCORE
      Arquivos: `js/sim.js`
...
- [x] T06 — Evento `bossSpawn` (CT-03) e log de andar HARDCORE (UI-01)
      Arquivos: `js/sim.js`
...
- [x] T07 — Status `wither`: tique de dano e funil de cura
      Arquivos: `js/sim.js`
...
- [x] T08 — Status do elemento aplicado no acerto do chefe
      Arquivos: `js/sim.js`
...
- [x] T09 — Fase de telegrafia do ataque perigoso, com cancelamento
      Arquivos: `js/sim.js`
...
- [x] T10 — Seleção do kit por chefe com `G.rng` e mecânica exclusiva do HARDCORE
      Arquivos: `js/sim.js`
...
- [x] T11 — Campo opcional `hc` no snapshot (CT-01)
      Arquivos: `js/net.js`
...
- [x] T12 — Anel de telegrafia com duração real (UI-03)
...
- [x] T13 — Marca textual HARDCORE na barra do chefe (UI-02)
      Arquivos: `js/ui.js`
...
- [x] T14 — Encaminhamento do evento `bossSpawn` na composição
      Arquivos: `js/main.js`
...
- [x] T15 — Asserções de comportamento em `tests/sim.test.mjs`
...
- [x] T16 — Curva, composição de escala e harness de duração em `tests/group.test.mjs`
...
- [x] T17 — Contrato de snapshot e evento crítico em `tests/net.test.mjs`
...
- [x] T18 — Calibração medida de `HARDCORE_HP_MULT` e `HARDCORE_ATK_MULT`
      Arquivos: `js/balance.js`
...
- [x] T19 — Janelas de tempo medidas em `tests/party10.test.mjs`
...
- [x] T20 — Regressão completa e inventário de cobertura
