...
- [x] T01 — Seção de áudio em `js/balance.js`, com o prazo de desengajamento calibrado
...
- [x] T02 — Tabela `AUDIO_ASSETS` em `js/data.js`
      Arquivos: `js/data.js`
...
- [x] T03 — Header de cache imutável para `/audio/` e permanência fora do `.vercelignore`
...
- [x] T04 — Diretório `/audio/` e manifesto de procedência `audio/CREDITOS.md`
...
- [x] T05 — `js/audioprefs.js`: preferência `sf-audio` com armazenamento injetável
...
- [x] T06 — `js/audio.js`: política de áudio pura, com backend e relógio injetáveis
...
- [x] T07 — Estado de engajamento e emissão de `bossEngage` pelo lado jogador→chefe
      Arquivos: `js/sim.js`
...
- [x] T08 — Emissão de `bossEngage` pelo lado chefe→jogador, nos três chamadores que conhecem o monstro
      Arquivos: `js/sim.js`
...
- [x] T09 — `bossDisengage` no tique, com invariante de alternância
      Arquivos: `js/sim.js`
...
- [x] T10 — Entrega do evento `loot` na composição, nos dois pontos que hoje o matam
      Arquivos: `js/main.js`
...
- [x] T11 — Transporte de `bossEngage` e `bossDisengage` na composição
      Arquivos: `js/main.js`
...
- [x] T12 — `js/audioweb.js`: backend Web Audio, destravamento por gesto e falha silenciosa
...
- [x] T13 — Painel `#audioPanel` e seu gatilho em `index.html`
      Arquivos: `index.html`
...
- [x] T14 — Estilo do painel e do gatilho em `styles.css`
      Arquivos: `styles.css`
...
- [x] T15 — `renderAudioPanel` e `toggleAudioPanel` em `js/ui.js`
      Arquivos: `js/ui.js`
...
- [x] T16 — Cola em `js/main.js`: instanciar a camada, assinar `applyEvent`, telas e carga preguiçosa
      Arquivos: `js/main.js`
...
- [x] T17 — Gatilho, atalho `m` e persistência na interação
      Arquivos: `js/main.js`
...
- [x] T18 — Suíte nova `tests/audio.test.mjs` e registro em `package.json`
...
- [x] T19 — Emissões e alternância em `tests/sim.test.mjs`
...
- [x] T20 — Criticidade, transporte e orçamento de bytes em `tests/net.test.mjs`
...
- [x] T21 — Navegador: destravamento, silêncio, painel e orçamento em `tests/browser.mjs`
...
- [x] T22 — Sincronia da faixa entre abas em `tests/multipeer.mjs`
...
- [x] T23 — Calibração medida de `BOSS_DISENGAGE_TIME`
...
- [x] T24 — Regressão completa e inventário de cobertura
