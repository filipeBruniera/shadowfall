...
- [ ] T13 — Contextos mobile e helpers de medição
...
- [ ] T14 — Casos `BARRA` e a parte solo de `TOQUE` e `MENU`
      Arquivos: `tests/browser.mjs`
...
- [ ] T16 — Abas em viewport mobile e helpers
...
- [ ] T17 — Casos `TOQUE` e `MENU` de sala
      Arquivos: `tests/multipeer.mjs`
